...
It can be found in https://github.com/nordnet/capacitor-hot-code-push-cli
*/
...
function suggestCliInstallation() {
  ...
  console.log('npm install -g capacitor-hot-code-push-cli');
  console.log('For more information please visit https://github.com/nordnet/capacitor-hot-code-push-cli');
  console.log('--------------------------');
}
